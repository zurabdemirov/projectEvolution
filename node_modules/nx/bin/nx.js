 ...
 */
function warnIfUsingOutdatedGlobalInstall(localNxVersion) {
    const globalVersion = require('../package.json').version;
    const isOutdatedGlobalInstall = globalVersion &&
        ((localNxVersion && (0, semver_1.major)(globalVersion) < (0, semver_1.major)(localNxVersion)) ||
            (!localNxVersion &&
                getLatestVersionOfNx() &&
                (0, semver_1.major)(globalVersion) < (0, semver_1.major)(getLatestVersionOfNx())));
