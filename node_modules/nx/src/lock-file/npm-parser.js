    ...
    sortedPaths.forEach((path) => {
        ...
        const shouldElevate = (segs) => {
            ...
            if (result.has(newPath)) {
                ...
                return (((_a = match.valueV1) === null || _a === void 0 ? void 0 : _a.version) === ((_b = source.valueV1) === null || _b === void 0 ? void 0 : _b.version) &&
                    ((_c = match.valueV3) === null || _c === void 0 ? void 0 : _c.version) === ((_d = source.valueV3) === null || _d === void 0 ? void 0 : _d.version));
            }
            return true;
        };
